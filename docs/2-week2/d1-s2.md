...
It uses a Turtle module and you will try to add some gameplay.
Do not forget to fork my replit

[<img
    src="/img/icons/replit.svg"
    alt="Link to a forkable replit"
/>](https://replit.com/@missPunter/turtle-game-starter#main.py)

[Link to replit](https://replit.com/@missPunter/turtle-game-starter#main.py)
